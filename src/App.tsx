            ...
            <div className="p-6 rounded-3xl bg-green-600/5 border border-green-500/20 shadow-lg shadow-green-500/5">
               <div className="flex items-center justify-between mb-4">
                  <div className="flex items-center gap-2">
                     ...
                     <span className="text-[10px] font-black text-green-400 uppercase tracking-widest">Giving Goal (Sadaqah)</span>
                  </div>
                  <button 
                    onClick={() => {
                    ...
                    className="text-[8px] font-bold text-white/30 hover:text-white transition-colors uppercase tracking-widest"
                  >
                    Adjust Goal
                  </button>
               </div>
               ...
               <div className="mb-4">
                  <div className="flex justify-between items-end mb-2">
                     ...
                     <div className="text-[10px] font-bold text-white/40 uppercase tracking-tighter">Goal: {currency} {charityGoal}</div>
                  </div>
               ...
               <div className="flex gap-2">
                  {[10, 50, 100].map(val => (
                    <button 
                      ...
                      className="flex-1 py-2 rounded-lg bg-white/5 border border-white/10 text-[9px] font-bold text-white/40 hover:bg-green-500/20 hover:text-green-400 hover:border-green-500/30 transition-all uppercase"
                    >
                      +{val}
                    </button>
                  ))}
                  <button 
                    ...
                    className="px-3 py-2 rounded-lg bg-white/5 border border-white/10 text-[9px] font-bold text-white/20 hover:text-red-400 transition-all uppercase"
                  >
                    Clear
                  </button>
               </div>
